defmodule TomBase.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      {Finch, name: TomBase.Finch},
      # Start a worker by calling: TomBase.Worker.start_link(arg)
      # {TomBase.Worker, arg},
    ...
    opts = [strategy: :one_for_one, name: TomBase.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    TomBaseWeb.Endpoint.config_change(changed, removed)
    :ok
  end
